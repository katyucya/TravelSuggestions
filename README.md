...
Muitos não sabem:<br>
❌	clima muito extremo (muito quente, muita chuva ou muita neve);<br>
❌ épocas de furacão, tornados, tsunâmis;<br>
❌ custo alto da viagem;<br>
❌ local perigoso para turista.

## 💡 Solução
O projeto resolve esse problema ao oferecer um agente conversacional inteligente, capaz de entregar recomendações contextualizadas e atualizadas.<br>
✔️	quais destinos são melhores em cada mês;<br>
✔️	quais locais têm melhor clima na época desejada;<br>
✔️ onde há eventos ou festivais interessantes;<br>
✔️ qual é o custo médio da viagem;<br>
✔️ alternativas semelhantes ao destino desejado.<br>

## 🧩 Recursos do Agente
✔️ Recomendação de destinos com base no perfil do usuário<br>
✔️ Sugestão de roteiros personalizados<br>
✔️ Estimativa de custos de viagem<br>
✔️ Informações sobre clima, atrações e transporte<br>
